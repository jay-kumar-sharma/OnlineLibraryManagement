									...
									<div class="col-sm-12">
										<div class="row">
											...
											<table border=4 bordercolor=red align=center width="90%">
												...
												<%!String name, email, password, mobile, dob, datetime;
												int id;%>
												...
												%>
												<form method="post" action="./AllUserDeleteCode">
