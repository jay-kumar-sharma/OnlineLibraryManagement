	...
	<div class="jumbotron hh">
		<div class="row">
			...
			<div class="col-sm-4" style="background: #282923; opacity: .9;">
				<center>
					<img src="pic/icon.png" class="img-fluid" style="height: 90px">
				</center>
				<h5 class="text-center text-success">UPLOAD BOOKS</h5>
				<form class="form-group" action="./BookUploadCode" method="post">
					<lavel class="text-white">NAME</lavel>
					<div class="input-group-append">
						<span class="input-group-text" style="background: cyan"><i
							class="fas fa-user"></i></span> <input type="text" name="name" required
					...
					<div class="input-group-append">
						<span class="input-group-text" style="background: cyan"><i
							class="fas fa-book"></i></span> <input type="text" name="book_name" required
							placeholder="ENTER BOOK NAME" class="form-control" />
					</div>
					<lavel class="text-white">AUTHOR NAME</lavel>
					<div class="input-group-append">
						<span class="input-group-text" style="background: cyan"><i
							class="fas fa-user"></i></span> <input type="text" name="author_name" required
							placeholder="ENTER BOOK AUTHOR NAME" class="form-control" />
					</div>
					<lavel class="text-white">UPLOAD BOOK</lavel>
					<div class="input-group-append">
						<span class="input-group-text" style="background: cyan"><i
							class="fas fa-upload"></i></span> <input type="file" name="upload_book"
