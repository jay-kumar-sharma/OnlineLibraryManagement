	...
	<div class="jumbotron hh">
		<div class="row">
			...
			<div class="col-sm-4" style="background: #282923; opacity: .9;">
				...
				<form class="form-group" action="./UserLoginCode" method="post">
					...
					<div class="input-group-append">
						<span class="input-group-text" style="background: cyan"><i
							...
							required placeholder="ENTER YOUR NAME" class="form-control" />
					</div>
					<div class="mt-3"></div>
					...
					<br> <a href="registration.jsp" class="ml-2 text-white h5"
						style="text-decoration: none">Don't have account ?</a>
					</h5>
				</form>
