									...
									<div class="col-sm-12">
										<div class="row">
											<table border=4 bordercolor=red align=center width=90%>
												...
												<%! String bookname, authorname, uploadbook, datetime;
												int id;%>
												...
												try {
													...
													while (rs.next()) {
														...
														uploadbook  = rs.getString("uploadbook");
														datetime = rs.getString("datetime");
												%>
												<form action="./allAddBookDeleteCode" method="post">
